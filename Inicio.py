...
with tab1:
    ...
    if st.button("Crear cuenta"):
        st.switch_page(r"pages\Registro - Usuarios.py")
    if st.button("Iniciar sesión"):
        st.switch_page(r"pages\Iniciar sesión - Usuarios.py")
...
with tab2:
    ...
    if st.button("Registra tu farmacia"):
        st.switch_page(r"pages\Registro - Farmacias.py")
    if st.button("Edita tu stock"):
        st.switch_page(r"pages\Iniciar sesión - Farmacias.py")
