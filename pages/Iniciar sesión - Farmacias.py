...
if st.session_state.l_in:
    ...
    if selected_tab == "Visualizar Stock":
        ...
        if not current_meds:
            ...
            st.markdown(''':green-background[:gray[En el caso de no tener stock de un medicamneto o de querer eliminarlo de la lista, ingrese 0 en la nueva cantidad de stock.]]''')
